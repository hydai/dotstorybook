...
> = {
  ...
  info: {
    prefix: "[INFO]",
    styles: "text-[var(--color-tertiary)] border-[var(--color-tertiary)]",
...
export function Badge({
  ...
  return (
    <span
      className={cn(
        "inline-flex items-center gap-1 border px-2.5 py-0.5 text-xs font-bold uppercase tracking-wider transition-colors cyber-chamfer-sm",
        config.styles,
        className
      )}
