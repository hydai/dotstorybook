...
const variantStyles: Record<NonNullable<ButtonProps["variant"]>, string> = {
  default: [
    ...
    "hover:bg-[var(--color-accent)] hover:text-[var(--color-text-inverse)] hover:shadow-[var(--shadow-glow)]",
  ].join(" "),
  solid: [
  ...
  outline: [
    ...
    "hover:bg-[var(--color-secondary)] hover:border-[var(--color-accent-hover)]",
  ].join(" "),
};
...
export function Button({
  ...
  return (
    <motion.button
      ...
      className={cn(
        "inline-flex items-center justify-center gap-2 font-semibold uppercase tracking-widest transition-all",
